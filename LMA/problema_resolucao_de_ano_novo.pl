...
mostrar_result :-
	...
	writeln("AMIGA 1 ":AMIGA1),
	writeln("AMIGA 2 ":AMIGA2),
	writeln("AMIGA 3 ":AMIGA3),
	writeln("AMIGA 4 ":AMIGA4),
	writeln("AMIGA 5 ":AMIGA5),
...
%%	EXEMPLO DE SAIDA  %%
%%	?- mostrar_result.
%%	AMIGA 1 : (thais,azul,aprender_ingles,julio,20)
%%	AMIGA 2 : (fabiana,branca,emagrecer,otavio,19)
%%	AMIGA 3 : (clarissa,verde,ler_mais,marcelo,26)
%%	AMIGA 4 : (vivian,amarela,viajar,alexandre,23)
%%	AMIGA 5 : (ana,vermelha,poupar_dinheiro,daniel,24)

%%	O tempo de execução é: XXXXXXXX sec
%%	true.

amiga([(NOME1, BOLSA1, RESOLUCAO1, NAMORADO1, IDADE1),
